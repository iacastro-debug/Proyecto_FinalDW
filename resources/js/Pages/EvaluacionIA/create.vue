          ...
          <UCard>
            ...
            <div class="space-y-4">
              <UFormGroup label="Paciente" required>
                ...
                <p class="text-sm text-gray-500 mt-1">Selecciona el paciente a evaluar</p>
              </UFormGroup>
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <UFormGroup label="Edad">
                  <p class="text-sm text-gray-500 mb-1">En años cumplidos. Si no ingresas, se calculará automáticamente</p>`n                <UInput v-model="form.edad" type="number" min="0" max="150" placeholder="Ej: 35" />
                </UFormGroup>
                <UFormGroup label="Género">
                  <p class="text-sm text-gray-500 mb-1">Género del paciente</p>`n                <USelect v-model="form.genero" :items="['M', 'F', 'Otro']" placeholder="Seleccionar..." />
                </UFormGroup>
              </div>
            </div>
          </UCard>
          ...
          <UCard>
            ...
            <div class="space-y-4">
              <UFormGroup label="Síntomas principales" required>
                ...
                <p class="text-sm text-gray-500 mt-1">Describe los síntomas que presenta el paciente de forma detallada</p>
              </UFormGroup>
              <UFormGroup label="Duración de los síntomas">
                <p class="text-sm text-gray-500 mb-1">¿Desde cuándo presenta estos síntomas?</p>`n                <UInput v-model="form.duracion_sintomas" placeholder="Ej: 3 días, 2 semanas, 1 mes" />
              </UFormGroup>
              <UFormGroup label="Nivel de dolor (1-10)">
                ...
                <p class="text-sm text-gray-500 mt-1">1 = dolor leve, 10 = dolor insoportable</p>
              </UFormGroup>
          ...
          <UCard>
            ...
            <div class="space-y-4">
              <UFormGroup label="Antecedentes">
                ...
                <p class="text-sm text-gray-500 mt-1">Enfermedades preexistentes, alergias, medicamentos actuales</p>
              </UFormGroup>
              <UFormGroup label="Urgencia percibida">
                <p class="text-sm text-gray-500 mb-1">¿Qué tan urgente considera que es la atención?</p>`n                <USelect v-model="form.urgencia_percibida" :items="[
              ...
              <UFormGroup label="Observaciones">
                ...
                <p class="text-sm text-gray-500 mt-1">Cualquier otro dato relevante</p>
              </UFormGroup>
            </div>
          </UCard>
